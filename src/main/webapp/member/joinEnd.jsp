...
<% 
	...
	// useBean액션을 이용해 객체를 생성
	// scope: page < request < session < application => 서버프로그램 시험
	// VO객체 => page, DAO객체 => session
	
	// application: 서버가 시작하고 종료될 때까지 하나의 객체를 공유한다.
...
<%-- forward방식으로 이동. 서버 내부에서 페이지 이동이 일어나며 이 때 같은 request, response를 사용 --%>
